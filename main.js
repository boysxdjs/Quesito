...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '@user 𝗛𝗼𝗹𝗮 𝘁𝗲 𝗱𝗼𝘆 𝗹𝗮 𝗯𝗶𝗲𝗻𝘃𝗲𝗻𝗶𝗱𝗮 𝗮 𝗲𝘀𝘁𝗲 𝗵𝗲𝗿𝗺𝗼𝘀𝗼 𝗴𝗿𝘂𝗽𝗼 🤖';
  conn.bye = '@user 𝗠𝘂𝘆 𝘀𝗲𝗻𝗰𝗶𝗯𝗹𝗲 🤖';
  conn.spromote = '@user 𝗘𝗿𝗲𝘀 𝗮𝗱𝗺𝗶𝗻 𝗱𝗲𝗹 𝗴𝗿𝘂𝗽𝗼 🤖';
  conn.sdemote = '@user 𝗗𝗲𝗷𝗮𝘀𝘁𝗲 𝗱𝗲 𝘀𝗲𝗿 𝗮𝗱𝗺𝗶𝗻 𝗱𝗲𝗹 𝗴𝗿𝘂𝗽𝗼 🤖';
  conn.sSubject = '𝗘𝗹 𝗻𝗼𝗺𝗯𝗿𝗲 𝗳𝘂𝗲 𝗰𝗮𝗺𝗯𝗶𝗮𝗱𝗼 𝗰𝗼𝗻 𝗲𝘅𝗶𝘁𝗼 🤖';
  conn.sIcon = '𝗟𝗮 𝗳𝗼𝘁𝗼 𝗳𝘂𝗲 𝗰𝗮𝗺𝗯𝗶𝗮𝗱𝗼 𝗰𝗼𝗻 𝗲𝘅𝗶𝘁𝗼 🤖';
  conn.sRevoke = '𝗘𝘀𝘁𝗲 𝗲𝗻𝗹𝗮𝗰𝗲 𝗮 𝘀𝗶𝗱𝗼 𝗿𝗲𝘀𝘁𝗮𝗯𝗹𝗲𝗰𝗶𝗱𝗼 𝗰𝗼𝗻 𝗲𝘅𝗶𝘁𝗼 🤖';
...
setInterval(async () => {
  ...
  const bio = `𝗘𝗦𝗧𝗔𝗦 𝗩𝗜𝗘𝗡𝗗𝗢 𝗘𝗟 𝗣𝗘𝗥𝗙𝗜𝗟 𝗗𝗘𝗟 𝗢𝗪𝗡𝗘𝗥 🤖 𝗢𝗡𝗟𝗬 𝗕𝗢𝗧 🤖`;
